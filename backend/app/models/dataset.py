...
class ExpressionMetadata(Base, TimestampMixin):
    ...
    qc_status: Mapped[str] = mapped_column(String(16), default="pending", nullable=False)
    preprocess_status: Mapped[str] = mapped_column(String(16), default="pending", nullable=False)
