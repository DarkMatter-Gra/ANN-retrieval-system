      ...
      <article className="panel">
        <div className="panel-head panel-head-row">
          <div>
            <h3>用户列表</h3>
            <p>
              共 {total} 个用户（当前页 {users.length} 条）
            </p>
          </div>
              ...
              {users.length ? (
                users.map((u) => (
                  <tr
                    key={u.user_id}
                    className={
                      String(u.user_id) === targetUserId ? "active-row" : ""
                    }
                  ...
                  >
                    ...
                    <td>{u.username}</td>
                    <td
                      style={{ color: "var(--text-soft)", fontSize: "0.88rem" }}
                    >
                      {u.email}
                    </td>
                    <td>
                      <span
                        style={{
                          ...
                          borderRadius: "6px",
                          fontSize: "0.8rem",
                          background: "rgba(105,226,195,0.12)",
                          color: "var(--accent)",
                        }}
                      >
