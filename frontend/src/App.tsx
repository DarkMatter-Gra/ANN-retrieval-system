      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route element={<RoleRoute roles={['admin', 'dev', 'user', 'readonly', 'auditor']} />}>
              <Route path="/app/datasets" element={<DatasetsPage />} />
            </Route>

            {/* Batch search: all except readonly, auditor */}
            <Route element={<RoleRoute roles={['admin', 'dev', 'user', 'service']} />}>
              <Route path="/app/batch-search" element={<BatchSearchPage />} />
            </Route>

            {/* Tasks: admin, service, readonly, auditor */}
            <Route element={<RoleRoute roles={['admin', 'service', 'readonly', 'auditor']} />}>
