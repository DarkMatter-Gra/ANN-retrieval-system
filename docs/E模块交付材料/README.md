...
本目录集中存放 E 模块“查询检索服务 + 测试文档演示”相关交付材料。
...
| 文件 | 内容 |
|---|---|
| `参考资料/ANN_API_文档_工程内最新版.md` | 当前工程内 API 文档副本 |
| `参考资料/ANN_API_文档_外层原始版.md` | 工程外层 API 文档副本 |
| `参考资料/C模块完成情况说明.md` | C 数据处理模块完成说明 |
| `参考资料/D模块完成总结.md` | D ANN 索引模块完成总结 |
| `参考资料/分工.png` | 小组分工图片 |
| `参考资料/需求分析文档_lab2.pdf` | 需求分析阶段 PDF |
| `参考资料/软件设计文档_第三次作业.pdf` | 软件设计阶段 PDF |
